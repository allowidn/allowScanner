#!/usr/bin/env python3
"""
Allow Web Security Scanner - Enterprise Edition v3.0
...
if __name__ == "__main__":
  ...
  /  _  \ |  | |  |   ______  _  __  /   _____/ ____ _____    ____   ____   ___________ 
 /  /_\  \|  | |  |  /  _ \ \/ \/ /  \_____  \_/ ___\\__  \  /    \ /    \_/ __ \_  __ \
/    |    \  |_|  |_(  <_> )     /   /        \  \___ / __ \|   |  \   |  \  ___/|  | \/
\____|__  /____/____/\____/ \/\_/   /_______  /\___  >____  /___|  /___|  /\___  >__|   
        \/                                  \/     \/     \/     \/     \/     \/       
    """, "cyan"))
    
    print(colored("Allow Web Security Scanner | Enterprise Edition v3.0", "blue", attrs=["bold"]))
